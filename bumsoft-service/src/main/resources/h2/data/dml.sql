...
VALUES (nextval('USER_SEQ'), 'Mohamed', 'Toure', 'mohamed.toure@gmail.com', 'p1234', true, today, null, null);
...
VALUES (nextval('INCOME_STATEMENT_SEQ'), 'House', 620, 1003, 1000, today, today, null);

insert into INCOME_STATEMENT(INC_STMT_ID, inc_stmt_name, inc_expected_amount, inc_stmt_ref_typ_id, inc_bs_usr_id, inc_created_at, inc_updated_at, inc_deleted_at)
VALUES (nextval('INCOME_STATEMENT_SEQ'), 'Food', 400, 1003, 1000, today, today, null);

insert into INCOME_STATEMENT(INC_STMT_ID, inc_stmt_name, inc_expected_amount, inc_stmt_ref_typ_id, inc_bs_usr_id, inc_created_at, inc_updated_at, inc_deleted_at)
VALUES (nextval('INCOME_STATEMENT_SEQ'), 'Netflix', 14, 1003, 1000, today, today, null);

insert into INCOME_STATEMENT(INC_STMT_ID, inc_stmt_name, inc_expected_amount, inc_stmt_ref_typ_id, inc_bs_usr_id, inc_created_at, inc_updated_at, inc_deleted_at)
VALUES (nextval('INCOME_STATEMENT_SEQ'), 'Transport', 100, 1003, 1000, today, today, null);

insert into INCOME_STATEMENT(INC_STMT_ID, inc_stmt_name, inc_expected_amount, inc_stmt_ref_typ_id, inc_bs_usr_id, inc_created_at, inc_updated_at, inc_deleted_at)
VALUES (nextval('INCOME_STATEMENT_SEQ'), 'Salary', 4000, 1002, 1000, today, today, null);

insert into INCOME_STATEMENT(INC_STMT_ID, inc_stmt_name, inc_expected_amount, inc_stmt_ref_typ_id, inc_bs_usr_id, inc_created_at, inc_updated_at, inc_deleted_at)
VALUES (nextval('INCOME_STATEMENT_SEQ'), 'Side Hustle 1', 12000, 1002, 1000, today, today, null);

insert into INCOME_STATEMENT(INC_STMT_ID, inc_stmt_name, inc_expected_amount, inc_stmt_ref_typ_id, inc_bs_usr_id, inc_created_at, inc_updated_at, inc_deleted_at)
VALUES (nextval('INCOME_STATEMENT_SEQ'), 'Car', 500, 1003, 1000, today, today, null);


-- Account
insert into ACCOUNT (ACC_ID, ACC_NAME, ACC_DESC, ACC_BS_USR_ID, ACC_REF_TYPE_ID, ACC_CREATED_AT, ACC_UPDATED_AT, ACC_DELETED_AT)
VALUES ( nextval('ACCOUNT_SEQ'), 'Belfius - Compte courant', 'Compte courant Belfius', 1000, 1004, today, today, null);

insert into ACCOUNT (ACC_ID, ACC_NAME, ACC_DESC, ACC_BS_USR_ID, ACC_REF_TYPE_ID, ACC_CREATED_AT, ACC_UPDATED_AT, ACC_DELETED_AT)
VALUES ( nextval('ACCOUNT_SEQ'), 'Belfius - Epargne', 'Compte épargne Belfius', 1000, 1005, today, today, null);

-- Transactions
insert into TRANSACTION (TRX_ID, TRX_VALUE, TRX_DESC, TRX_DATE, TRX_ACC_ID, TRX_INC_STMT_ID, TRX_REF_TYP_ID)
values ( nextval('TRANSACTION_SEQ'), -99.9, 'Débit de compte', today, 1000, 1001, 1000);

insert into TRANSACTION (TRX_ID, TRX_VALUE, TRX_DESC, TRX_DATE, TRX_ACC_ID, TRX_INC_STMT_ID, TRX_REF_TYP_ID)
values ( nextval('TRANSACTION_SEQ'), -12.9, 'Débit de compte', today, 1000, 1001, 1000);

insert into TRANSACTION (TRX_ID, TRX_VALUE, TRX_DESC, TRX_DATE, TRX_ACC_ID, TRX_INC_STMT_ID, TRX_REF_TYP_ID)
values ( nextval('TRANSACTION_SEQ'), -19.9, 'Débit de compte', today, 1000, 1001, 1000);

insert into TRANSACTION (TRX_ID, TRX_VALUE, TRX_DESC, TRX_DATE, TRX_ACC_ID, TRX_INC_STMT_ID, TRX_REF_TYP_ID)
values ( nextval('TRANSACTION_SEQ'), -43.9, 'Débit de compte', today, 1000, 1001, 1000);

insert into TRANSACTION (TRX_ID, TRX_VALUE, TRX_DESC, TRX_DATE, TRX_ACC_ID, TRX_INC_STMT_ID, TRX_REF_TYP_ID)
values ( nextval('TRANSACTION_SEQ'), 4000, 'Crédit de compte', today, 1000, 1004, 1001);

insert into TRANSACTION (TRX_ID, TRX_VALUE, TRX_DESC, TRX_DATE, TRX_ACC_ID, TRX_INC_STMT_ID, TRX_REF_TYP_ID)
values ( nextval('TRANSACTION_SEQ'), 1200, 'Crédit de compte', today, 1001, 1004, 1001);

insert into TRANSACTION (TRX_ID, TRX_VALUE, TRX_DESC, TRX_DATE, TRX_ACC_ID, TRX_INC_STMT_ID, TRX_REF_TYP_ID)
values ( nextval('TRANSACTION_SEQ'), 1789, 'Crédit de compte', today, 1000, 1005, 1001);

insert into TRANSACTION (TRX_ID, TRX_VALUE, TRX_DESC, TRX_DATE, TRX_ACC_ID, TRX_INC_STMT_ID, TRX_REF_TYP_ID)
values ( nextval('TRANSACTION_SEQ'), -18.8, 'Débit de compte', today, 1000, 1001, 1000);
