...
VALUES ( nextval('ACCOUNT_SEQ'), 'A0001', 'Live', 'Compte courant', 1000, 1004, current_date, current_date, null);

insert into ACCOUNT (ACC_ID, ACC_NUM, ACC_NAME, ACC_DESC, ACC_BS_USR_ID, ACC_TYPE, ACC_CREATED_AT, ACC_UPDATED_AT, ACC_DELETED_AT)
VALUES ( nextval('ACCOUNT_SEQ'), 'A0002', 'Epargne', 'Compte épargne Belfius', 1000, 1005, current_date, current_date, null);

insert into ACCOUNT (ACC_ID, ACC_NUM, ACC_NAME, ACC_DESC, ACC_BS_USR_ID, ACC_TYPE, ACC_CREATED_AT, ACC_UPDATED_AT, ACC_DELETED_AT)
VALUES ( nextval('ACCOUNT_SEQ'), 'A0003', 'Maison', 'Budget pour les charges de maison', 1000, 1005, current_date, current_date, null);

insert into ACCOUNT (ACC_ID, ACC_NUM, ACC_NAME, ACC_DESC, ACC_BS_USR_ID, ACC_TYPE, ACC_CREATED_AT, ACC_UPDATED_AT, ACC_DELETED_AT)
VALUES ( nextval('ACCOUNT_SEQ'), 'A0004', 'Nourriture', 'Budget nourriture', 1000, 1005, current_date, current_date, null);

insert into ACCOUNT (ACC_ID, ACC_NUM, ACC_NAME, ACC_DESC, ACC_BS_USR_ID, ACC_TYPE, ACC_CREATED_AT, ACC_UPDATED_AT, ACC_DELETED_AT)
VALUES ( nextval('ACCOUNT_SEQ'), 'A0005', 'Abonnements', 'Budget abonnements', 1000, 1005, current_date, current_date, null);
