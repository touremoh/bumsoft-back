...
CREATE TABLE IF NOT EXISTS ACCOUNT (
   ...
   ACC_BS_USR_ID INTEGER,
   ACC_REF_TYPE_ID INTEGER,
   ACC_CREATED_AT DATE,
   ACC_UPDATED_AT DATE,
   ACC_DELETED_AT DATE
);
...
CREATE TABLE IF NOT EXISTS TRANSACTION (
   ...
   TRX_DATE DATE,
   TRX_ACC_ID INTEGER,
   TRX_INC_STMT_ID INTEGER,
   TRX_REF_TYP_ID INTEGER
);
...
CREATE TABLE IF NOT EXISTS INCOME_STATEMENT (
  INC_STMT_ID INTEGER NOT NULL,
  INC_STMT_NAME VARCHAR(250),
  INC_EXPECTED_AMOUNT DECIMAL(18,2),
  INC_STMT_REF_TYP_ID INTEGER,
  INC_BS_USR_ID INTEGER,
  INC_CREATED_AT DATE,
  INC_UPDATED_AT DATE,
  INC_DELETED_AT DATE
);
